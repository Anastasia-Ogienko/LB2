...
public class class1 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Часть 1: ввод и сортировка");
        ...
        boolean mark = false;
        *//*тут мы написали не for , а foreach*//*
        for (int elem:arr) {
            if(number==elem) {
                mark=true;
                break;
        ...
        int last = arr1.length - 1; //последний элемент массива
        ...
        System.out.println("Часть 2: Коллекции");
